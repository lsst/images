...
class TransformTestCase(unittest.TestCase):
    ...
    def test_camera(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".fits", delete_on_close=False, delete=True) as tmp:
            ...
            with FitsOutputArchive.open(tmp.name) as output_archive:
                ...
                pixels_to_fp_ser = output_archive.serialize_direct("pixels_to_fp", pixels_to_fp.serialize)
            ...
            self.assertEqual(len(pixels_to_fp_ser.boundss), 2)
    ...
    def compare_to_legacy_wcs[F: Frame](
        self,
        legacy_wcs: Any,
