...
class RegionTestCase(unittest.TestCase):
    ...
    def test_intersection(self) -> None:
        ...
        # Intersections with the boxes themselves should return boxes when
        # possible.
        self.assertEqual(self.a.intersection(self.b.bbox), Box.factory[4:6, 3:5])
        self.assertEqual(self.a.bbox.intersection(self.b), Box.factory[4:6, 3:5])
        self.assertEqual(
            # A Box is not possible when the result is not simple.
            self.a.union(self.c).intersection(self.b.bbox),
            self.a.union(self.c).intersection(self.b),
        )
