...
class MaskPlane:
    ...
    @classmethod
    def read_afw(cls, header: astropy.io.fits.Header) -> dict[str, int]:
...
class Mask:
    ...
    @classmethod
    def read_afw(cls, hdu: astropy.io.fits.ImageHDU | astropy.io.fits.CompImageHDU) -> Mask:
        ...
        start = (-dy, -dx)
        plane_dict = MaskPlane.read_afw(hdu.header)
