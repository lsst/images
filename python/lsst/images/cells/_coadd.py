...
class CellCoadd(MaskedImage):
    ...
    patch
        ...
        to a single patch.
    provenance
        Information about the images that went into the coadd.  May only be
        provided if ``patch`` is also provided.
    """
    ...
    def deserialize(  # type: ignore[override]
        ...
        *,
        ...
        coadd_provenance = (
            CoaddProvenance.deserialize(model.provenance, archive, bbox=bbox)
    ...
    def from_legacy(
        legacy: Any,
        *,
        unit: astropy.units.Unit | None = astropy.units.nJy,
        ...
        unit
            Units of the image.  Defaults to ``nJy``.
        plane_map
